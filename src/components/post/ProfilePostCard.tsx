...
const ProfilePostCard = () => {
    return (
        <div className="border-2 transition ease-in-out duration-300 hover:scale-105 border-slate-500 cursor-pointer relative rounded-xl shadow-lg bg-blue-500 h-[350px] md:w-[17rem] lg:w-[18.5rem]">
